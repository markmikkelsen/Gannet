...
% Flags
    ...
    MRS_struct.p.append   = 1; % 1 = YES, append PDF outputs into one PDF (separately for each module) (requires export_fig to be added
                               % to the search path)
    MRS_struct.p.silent   = 0; % 1 = YES, do not dynamically display output figures
