...
if MRS_struct.p.TE(ii) < 100
    ...
    modelParamInit = [ maxinGSH         -350     2.95  ...
                      -maxinGSH         -500     2.76  ...
                       maxinGSH         -200     2.72  ...
                       maxinAsp*0.5     -1000    2.615 ...
                       maxinAsp         -500     2.57  ...
                       maxinAsp*0.5     -1000    2.50  ...
                       s*maxinAsp*0.15  -1000    2.47  ...
                      -maxinGSH         -1500    2.36];

    lb = [ 0               -2000  2.95-0.01  ...
          -4*maxinGSH      -2000  2.76-0.01  ...
           0               -1000  2.72-0.03  ...
           2*maxinAsp*0.5  -2000  2.615-0.01 ...
           2*maxinAsp      -1000  2.57-0.01  ...
           2*maxinAsp*0.5  -2000  2.50-0.01  ...
           0               -1000  2.47-0.01  ...
          -2*maxinGSH      -2000  2.36-0.02];

    ub = [ 2*maxinGSH    -100  2.95+0.01  ...
           0             -100  2.76+0.01  ...
           1.5*maxinGSH  -100  2.72+0.03  ...
           0             -100  2.615+0.01 ...
           0             -100  2.57+0.01  ...
           0             -100  2.50+0.01  ...
          -2*maxinAsp    -100  2.47+0.01  ...
           0             -100  2.36+0.02];
    ...
    modelParamInit = [maxinGSH         -300   2.95 ...
